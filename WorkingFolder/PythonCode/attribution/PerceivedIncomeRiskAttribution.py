...
#
#
# Income risks matter for both individual behaviors and aggregate outcomes. With identical expected income and identical risk preferences, different degrees of risks lead to different saving/consumption and portfolio choices. This is well understood in models in which agents are inter-temporally risk-averse, or prudent (<cite data-cite="kimball1990precautionary">(Kimball, 1990)</cite>, <cite data-cite="carroll2001liquidity">(Carroll and Kimball, 2001)</cite>), and the risks associated with future marginal utility motivate precautionary motives(<cite data-cite="caballero1990consumption">(Caballero, 1990)</cite>). Since it is widely known from the empirical research that idiosyncratic income risks are at most partially insured (<cite data-cite="blundell_consumption_2008">(Blundell, et al., 2008)</cite>) or because of borrowing constraints, such behavioral regularities equipped with market incompleteness leads to ex-post unequal wealth distribution and different degrees of marginal propensity to consume (MPC) (<cite data-cite="huggett1993risk">(Huggett,1993)</cite>, <cite data-cite="aiyagari1994uninsured">(Aiyagari, 1994)</cite>). This has important implications for the transmission of macroeconomic policies\footnote{<cite data-cite="krueger2016macroeconomics">(Krueger, et al., 2016)</cite>, <cite data-cite="kaplan2018monetary">(Kaplan, et al., 2018)</cite>, <cite data-cite="auclert2019monetary">(Auclert, 2019)</cite>, <cite data-cite="bayer2019precautionary">(Bayer, et al., 2019)</cite>.}   
#
# But how do agents form perceptions about their income risks? Although this question is straightforward under the assumption of full-information rational expectation(FIRE), namely people perfectly understand the income process in the model, it bears more scrutiny given the mounting evidence that people form expectations in ways deviating from the FIRE benchmark. A long list of the research relied upon survey data has established strong evidence against FIRE for macroeconomic variables\footnote{For instance, <cite data-cite="mankiw2003disagreement">(Mankiw et al. 2003)</cite>, <cite data-cite="coibion2012can">(Coibion and Gorodnichenko. 2012)</cite>, <cite data-cite="coibion2012can">(Coibion and Gorodnichenko, 2012)</cite>, <cite data-cite="das2017socioeconomic">(Das et al. 2017)</cite>, <cite data-cite="fuhrer2018intrinsic">(Fuhrer. 2018)</cite>, <cite data-cite="coibion2018firms">(Coibion et al. 2018)</cite> and so forth.} such as inflation, unemployment rate, and stock market performances. Furthermore, they have also facilitated a variety of theories of expectation formation such as rational inattention (<cite data-cite="sims2003implications">(Sims,2003)</cite>), sticky expectation(<cite data-cite="mankiw2002sticky">(Mankiw and Reis,2003)</cite>), noisy information (<cite data-cite="woodford2001imperfect">(Woodford, 2001)</cite>), least-square learning (<cite data-cite="evans2012learning">(Evans and Honkapohja, 2012)</cite>), experience-based learning  (<cite data-cite="malmendier2015learning">(Malmendier and Nagel, 2015)</cite>) , diagnostic expectations  (<cite data-cite="bordalo2018diagnostic">(Bordalo et al. 2018)</cite>) and so forth. But the existing literature has had limited emphasis on the belief formation regarding the higher moments such as risks, especially that of individual-specific state variables such as income. This is so either because many canonical models of these theories do not directly have a prediction on risk perceptions, or the existing research mostly focuses on the first moment namely expectation. A good example for the former is diagnostic expectation while one for the latter is experience-based learning\footnote{More specifically, the canonical model of diagnostic expectation assumes constant variance of the variable of the forecast and people extrapolate the expected mean of the variable based on surprises. Experience-based learning focuses on the expected level of inflation instead of inflation uncertainty}. 
#
# This paper fills such a gap. On the theoretical aspect, I construct a subjective model of learning that features agents' imperfect understanding of the size as well as the nature of income risks. In terms of the size, the imperfect understanding is modeled as a lack of knowledge of the true parameter of an assumed income process. Agents form their best guess about the parameters by learning from the past experienced income of their own as well as others. Such experience-based learning mechanisms engender the perceived risks to be dependent on age, generation, and macroeconomic history. At the same time, the imperfect understanding of the nature of risks is captured by assuming that individuals do not understand if the shocks are persistent/permanent or relatively transitory, or if the income risks are commonly shared aggregate shock or idiosyncratic ones. They learn about the model based on a subjective determination of the nature of the past shocks, which is called *attribution* in this paper. The role of attribution in perception formation and prediction has been long developed in social psychology literature\footnote{See <cite data-cite="heider1958psychology">(Heider, 1958)</cite>, <cite data-cite="kelley1967attribution">(Kelley, 1967)</cite>, <cite data-cite="kelley1980attribution">(Kelley and Michela, 1980)</cite>, <cite data-cite="fiske1991social">(Fiske and Taylor, 1991)</cite>, and <cite data-cite="weiner2010attribution">(Weiner, 2010)</cite>.}. This paper adapts the idea into a learning framework used by economists. With different subjective attributions, agents arrive at different degrees of model parameter uncertainty, thus different perceptions about income risks. 
#
# This general framework allows me to explore the implications of different attributions. For instance, under individual learning where agents only observe their own past income realizations, higher perceived persistence of the income shocks induces higher risk perceptions. It also leads to higher subjective uncertainty about the parameters since the time-serial correlation among shocks. In the presence of social learning where agents subjectively determine the nature, I show that a higher degree of external attribution, i.e. perceiving the shocks to be common ones instead of idiosyncratic ones, leads to higher risk perceptions. This introduces a well-specified channel through which some imperfect understanding of the nature of shocks leads to differences in risk perceptions. The intuition for this is straightforward. As an econometrician would perfectly understand, learning comes from variations in the sample either cross-sectionally or over time. As agents subjectively perceive the correlation of their own income shocks and others' to be higher, the cross-sectional variation from the sample useful to the learning is reduced, which leads to higehr uncertainty associated with the parameter estimate. I show such a mechanism is generalizable to different assumed income processes such as AR(1) or one with permanent/transitory components of time-varying risks. 
#
