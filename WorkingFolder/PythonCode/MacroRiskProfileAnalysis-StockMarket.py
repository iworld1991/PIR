...
# # Perceived Income Risks and Macroeconomic Conditions (stock market)
#
#
...
#f = open('../Tables/latex/macro_corr_stock.tex', 'w')
...
#corr_df.to_excel('../Tables/macro_corr_stock.xlsx')
...
## save 
#corr_df.T.to_excel('../Tables/macro_corr_HHinc_stock_gr.xlsx')
corr_df.T
...
## save 
#corr_df.T.to_excel('../Tables/macro_corr_educ_stock_gr.xlsx')
corr_df.T
...
for i,moms in enumerate( ['exp','var','iqr','rexp','rvar']):
    ...
    ax2.legend(loc = 2,
              fontsize = fontsize)
    #plt.savefig('../Graphs/pop/tsMed3mv'+str(moms)+'_stock.jpg')
...
for i,moms in enumerate( ['exp','var','iqr','rexp','rvar']):
    ...
    ax2.tick_params(axis='both',
                    which='major',
                    labelsize = fontsize)
    #plt.savefig('../Graphs/pop/tsMean3mv'+str(moms)+'_stock.jpg')
    #cor,pval =st.pearsonr(np.array(dt_combM['sp500']),
