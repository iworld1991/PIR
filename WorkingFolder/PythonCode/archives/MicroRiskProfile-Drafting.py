...
for mom in ['incexp']:
    ...
    plt.xlabel('age group \n (from young to old)',
              size = 15)
    plt.ylabel('expected growth',size = 15)
...
for i in range(len(gplist)):
    for j in range(2):
        ...
        # settings 
        bp.set_xlabel(gp,fontsize = 15)
        bp.tick_params(labelsize = 15)
        bp.set_ylabel(mom,fontsize = 15)
        
plt.savefig('../Graphs/ind/boxplot_skew_byear_gr.jpg')
