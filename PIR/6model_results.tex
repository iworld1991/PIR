...
\begin{figure}[!ht]
	...
	\begin{center}
		\adjustimage{max size={0.3\linewidth}{0.4\paperheight}}{figures/lorenz_a_test.png} 
			...
			\adjustimage{max size={0.3\linewidth}{0.4\paperheight}}{figures/lorenz_a_eq.png}
...
\begin{figure}[!ht]
	...
	\adjustimage{max size={0.6\linewidth}{0.4\paperheight}}{figures/life_cycle_a_compare_pe.png} \\
		\adjustimage{max size={0.3\linewidth}{0.4\paperheight}}{figures/lorenz_a_compare_ge.png}
