...
\begin{table}[!ht]
    \centering
    \caption{Summary statistics of SIPP sample used for risk estimation}
...
educ                 &        &            \\
\hline 
HS dropout (22\%)    & 13,823 & 0.09       \\
HS graduate (46\%)   & 28,332 & 0.09       \\
College/above (30\%) & 18,279 & 0.12       \\\hline 
gender               &        &            \\
\hline 
male (55\%)          & 33,740 & 0.09       \\
female (44\%)        & 26,694 & 0.1        \\
\hline 
Full sample (100\%)        & 60,434 & 0.1       \\
\hline 
\end{tabular}
...
\begin{table}
	...
	\label{risk_compare}
		...
		\hline \hline 
                     ...
                     & PerceivedRisk & PerceivedRisk(median) & RealizedGroupRisks & RealizedPRisk & RealizedTRsk \\
                     \hline 
gender               &               &                       &                         &               &              \\
\hline 
1 (50\%)             & 0.03          & 0.022                 & 0.103                   & 0.117         & 0.024        \\
2 (49\%)             & 0.028         & 0.022                 & 0.101                   & 0.116         & 0.024        \\
\hline  
