...
\begin{figure}[!ht]
	...
	\begin{center}
		\adjustimage{max size={0.5\linewidth}{0.4\paperheight}}{figures/lorenz_curve_a_eq.png}
	\adjustimage{max size={0.8\linewidth}{0.4\paperheight}}{figures/life_cycle_a_eq.png}
\end{center}
...
\begin{figure}[!ht]
	...
	\begin{center}
		\adjustimage{max size={0.5\linewidth}{0.4\paperheight}}{figures/lorenz_curve_a_compare_ge.png}
	\adjustimage{max size={0.8\linewidth}{0.4\paperheight}}{figures/life_cycle_a_compare_ge.png}
\end{center}
