...
\begin{frame}{By \textbf{age}/gender/education}
	...
	\begin{itemize}
		...
		\hyperlink{appendix:age_gender_educ_level_compare_figure}{\beamerbutton{growth}}
		\quad  \hyperlink{appendix:age_compare_figure}{\beamerbutton{by age}}  
...
\label{tsMean3mvrvar_he}
	...
	\quad  \hyperlink{appendix:tsMean3mvrexp_he}{\beamerbutton{expected growth}} 
		\quad  \hyperlink{appendix:PR_macro_labor_market_correlation}{\beamerbutton{correlation}} 
			\quad  \hyperlink{appendix:PR_state_labor_market}{\beamerbutton{state-level evidence}}  
\end{frame}
...
\begin{frame}{StE Distribution of the objective model (preliminary)}
	\label{objectivemodelresults}
		...
		\end{subfigure} 
	\end{figure}
\hyperlink{appendix:calibration}{\beamerbutton{Calibration}}  \hyperlink{appendix:partial_eq}{\beamerbutton{Partial equilibrium}} 
\end{frame}
...
\begin{frame}{Appendix: expected growth by age}
	...
	\end{figure}
	\begin{itemize}
		\item e.g. a male high school graduate aged 30 \quad  \hyperlink{age_compare}{\beamerbutton{Back}} 
		%	\item in line with existing findings, for instance  
		%	\cite{bloom2018great}. 
	\end{itemize}
\end{frame}
...
\begin{frame}{Appendix: calibration of the objective model}
	...
	\begin{table}[p]
		...
		\begin{tabular}{@{}llll@{}}
\hline 
			block                              & parameter name              & values & source                                                                  \\ \hline 
			\multirow{4}{*}{risk}              & $\sigma_\psi$               & 0.15   & Median estimates from the literature  \\
			& $\sigma_	heta$              & 0.1    & Median estimates from the literature  \\
			& $U2U$                       & 0.18   & Median estimates from the literature \\
			& $E2E$                       & 0.96   & Median estimates from the literature  \\
			\multirow{2}{*}{initial condition} & $\sigma_\psi^{\text{init}}$ & 0.629  & Estimated for age 25 in the 2016 SCF)                                   \\
			& bequest ratio               & 0      & assumption                                                              \\
			\multirow{3}{*}{life cycle}        & $T$                         & 40     & standard assumption                                                     \\
			& $L$                         & 60     & standard assumption                                                     \\
			& $1-D$                       & 0.994  & standard assumption                                                     \\
			\multirow{2}{*}{preference}        & $\rho$                      & 1.5    & standard assumption                                                     \\
			& $\beta$                     & 0.98   & standard assumption                                                     \\
			\multirow{3}{*}{policy}            & $\lambda$                   & 0      & endogenously determined                                                 \\
			& $\lambda_{SS}$              & 0      & endogenously determined                                                 \\
			& $\mu$                       & 0.15   & standard assumption                                                     \\
			\multirow{4}{*}{production}        & $W$                         & 1      & target values in steady state                                           \\
			& K2Y ratio                   & 3      & target values in steady state                                           \\
			& $\alpha$                    & 0.33   & standard assumption                                                     \\
			& $\delta$                    & 0.025  & standard assumption                                                     \\ \hline 
		\end{tabular}
		\end{adjustbox}
	\end{table}
	\hyperlink{objectivemodelresults}{\beamerbutton{Back}} 
\end{frame}
