...
\begin{frame}{StE Distribution model with lower PR (LPR)}
	...
	\begin{figure}[!ht]
		\begin{center}
			\adjustimage{max size={0.3\linewidth}{0.35\paperheight}}{figures/lorenz_a_compare_pe.png}
			\adjustimage{max size={0.6\linewidth}{0.35\paperheight}}{figures/life_cycle_a_compare_pe.png} \\
			\adjustimage{max size={0.3\linewidth}{0.35\paperheight}}{figures/lorenz_curve_a_compare_ge.png}
			\adjustimage{max size={0.6\linewidth}{0.35\paperheight}}{figures/life_cycle_a_compare_ge.png} \\
		\end{center}
	\end{figure}
...
\begin{frame}{Calibration of survey-based PR in the model}
...
\begin{frame}{Estimated versus survey-implied risks}
	\begin{itemize}
		\item \textcolor{blue}{panel data}: agents perceive $\underbrace{\Gamma =\{\sigma^2_\psi,\sigma^2_\theta,\mho,E\}}_{\text{income risk parameters}}$ 
			\item \textcolor{blue}{survey data}: each agent $i$ swings between two  subjective risk state  $\tilde \Gamma_{i,\tau} = \tilde \Gamma_l$ and $\tilde \Gamma_{i,\tau} = \tilde \Gamma_h$, with transition matrix $\Omega$. 
			\begin{itemize}
...
\begin{frame}{Extension: \textcolor{red}{subjective} PR}
	\begin{itemize}
		\item A robustness check against possible behavioral bias 
		\item An experiment model that breaks down the model implications into two two channels 
		\begin{itemize}
...
\begin{frame}{Economic environment}
	...
	\pause
		...
		\end{itemize}
	\pause
		\item \textcolor{blue}{Accidental bequests}:  lum-sum of a fraction of the deceased' wealth
	%	 \begin{itemize}
