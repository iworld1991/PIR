...
\begin{frame}{StE Distribution model with lower PR (LPR)}
	...
	\begin{figure}[!ht]
		\begin{center}
			\adjustimage{max size={0.3\linewidth}{0.35\paperheight}}{figures/lorenz_a_compare_pe.pdf}
			\adjustimage{max size={0.6\linewidth}{0.35\paperheight}}{figures/life_cycle_a_compare_pe.pdf} \\
			\adjustimage{max size={0.3\linewidth}{0.35\paperheight}}{figures/lorenz_a_compare_ge.pdf}
			\adjustimage{max size={0.6\linewidth}{0.35\paperheight}}{figures/life_cycle_a_compare_ge.pdf} \\
		\end{center}
	\end{figure}
