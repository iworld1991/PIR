...
\begin{frame}{Heterogeneous risks $\rightarrow$ differential savings}
	%\begin{itemize}
	%\item Heterogeneous income risks $\rightarrow$ different precautionary motives $\rightarrow$ additional wealth inequality and heterogeneity in $MPC$s
	%\begin{itemize}
	%	\item compared to a benchmark model without \textcolor{orange}{preference heterogeneity} or \textcolor{orange}{illiquid assets} 
	%\end{itemize}
%\pause 
%\item Lower perceived risk $\rightarrow$ less precautionary saving motive, $\rightarrow$  less saving across distribution 
%\begin{itemize}
...
\begin{frame}{Limitations with risk estimates from panel data}
	\begin{itemize}
		...
		\begin{itemize}
			...
			%but economists have to estimate it at the group level.
		\end{itemize}
		\pause
...
\begin{frame}{Perceived risks and household spending}
	...
	\begin{eqnarray*}
				E_{i,t} (\Delta c_{i,t+1}) = u_0 + u_1 E_{i,t}(\Delta w_{i,t})+u_2 \text{Var}_{i,t} (\Delta w_{i,t+1}) + \xi_{i,t}  
	\end{eqnarray*}
	\begin{table}
		\centering
...
\begin{frame}{Taking stock}
	...
	\begin{table}[p]
		...
		\input{tables/model_compare_summary.tex}
	\end{adjustbox}
	\end{table}
\end{frame}
...
\begin{frame}{Value functions under different assumptions}
	\begin{itemize}
...
\begin{frame}{Appendix: Extrapolation from \textcolor{blue}{individual} experiences}
	...
	\end{table}
\hyperlink{otherresults}{\beamerbutton{Back}}    
\end{frame}
...
\begin{frame}{Appendix: PR and current labor market condition}
	...
	\end{itemize}
	\quad  \hyperlink{otherresults}{\beamerbutton{Back}} 
\end{frame}
